...
const NewsEdit: React.FC<props> = ({ addNews, subCategories }) => {
  ...
  const _onChange = (e) => {
    ...
    } else if (e.target.name === "category" && val === "") err.category = true;
        ...
        <div className="relative col-span-3">
          ...
          <div className="mt-6 flex">
            ...
            {loading && (
              <button
                type="button"
                className="bg-sky-700 text-white dark:bg-white dark:text-black px-8 py-3 rounded-lg my-6 flex items-center justify-center mr-2"
                disabled={true}
              >
                Wait
              </button>
